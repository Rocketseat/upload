    ...
    <div className="space-y-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        checked
                          ...
                          : field.onChange(
                              field.value.filter((value) => value !== trigger),
                            )
                      }
                    />
                  )}
      ...
      {errors.triggers && (
        <p className="text-sm font-medium text-red-500 dark:text-red-400">
          {dictionary.webhook_triggers_error}
        </p>
      )}
      <Separator />
      <p className="text-sm text-muted-foreground">
        {dictionary.webhook_triggers_input_all_events}
        <button
          type="button"
          onClick={handleSelectAllTriggers}
          className="bg-transparent underline"
        >
          {dictionary.webhook_triggers_select_all_button}
        </button>
        ?
      </p>
    </div>
